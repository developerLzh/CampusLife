...
public enum ErrCodeTran {
     ...
     * 車輛正在使用.
     */
    VEHICLE_IS_BUSY(31054, "車輛正在使用"),

    /**
     * 您還未綁定車輛，請聯繫管理員
     */
    NO_VEHICLE_CANNOT_ONLINE(31041, "您還未綁定車輛，請聯繫管理員"),
    /**
     * 不能同時執行多個訂單
     */
    CANNOT_DOING_MORE_ORDERS(31042, "不能同時執行多個訂單"),
    /**
     * 時間差異
     */
    PHONE_TIME_ERROR(50018, "手機時間與服務器時間相差過大,請調整手機時間"),
    /**
     * 上線管控
     */
    ONLNE_TIMES_LIMIT(50020, "由於上線管控限制，您目前不能聽單，請聯繫管理員處理"),
    /**
     * REDIS_LOCK
     */
    REDIS_LOCK(60001, "操作過於頻繁，請稍後再試！"),
    /**
     * SERVER_DOWN
     */
    SERVER_DOWN(60004, "服務器維護中，請稍後再試！"),
    /**
     * 擁有未選擇支付類型的訂單
     */
    HAS_NO_PAY_TYPE(31043, "擁有沒有選擇支付類型的訂單"),
    /**
     * 在線支付未開啟
     */
    EMPLOY_ONLINE_NOT_OPEN(31044, "在線支付未開啟");
