...
public enum ErrCode {
     ...
     * 上线管控
     */
    ONLNE_TIMES_LIMIT(50020, "由于上线管控限制，您目前不能听单，请联系管理员处理"),
    /**
     * REDIS_LOCK
     */
    REDIS_LOCK(60001, "操作过于频繁，请稍后再试！"),
    /**
     * SERVER_DOWN
     */
    SERVER_DOWN(60004, "服务器维护中，请稍后再试！"),
    /**
     * 拥有未选择支付类型的订单
     */
    HAS_NO_PAY_TYPE(31043, "拥有没有选择支付类型的订单"),
    /**
     * 在线支付未开启
     */
    EMPLOY_ONLINE_NOT_OPEN(31044, "在线支付未开启");
